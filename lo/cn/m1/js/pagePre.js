...
function dragEnd(obj,num,dragArr){
	obj.eq(num).css({
	...
	if(impact(obj.eq(num),$('.hot').eq(0))){
		...
		dragArr[0]=num+1;
	}else if(impact(obj.eq(num),$('.hot').eq(1))){
		if (dragArr[1]!=0) {
		...
		obj.eq(num).css('top',objT+'px');
		dragArr[1]=num+1;
	}else if(impact(obj.eq(num),$('.hot').eq(2))){
		if (dragArr[2]!=0) {
		...
		obj.eq(num).css('top',objT+'px');
		dragArr[2]=num+1;
	}else if(impact(obj.eq(num),$('.hot').eq(3))){
		if (dragArr[3]!=0) {
		...
		obj.eq(num).css('top',objT+'px');
		dragArr[3]=num+1;
	}else if(impact(obj.eq(num),$('.hot').eq(4))){
		if (dragArr[4]!=0) {
