...
function pageResponse(opt) {
    ...
    function template(mode, obj, num) {
        ...
        _o.msTransformOrigin = or;
        _o.MozTransformOrigin = or;
        _o.oTransformOrigin = or;
        // _o.webkitTransform = "scale(" + num + ")";
        // _o.transform = "scale(" + num + ")";
        _o.webkitTransform = "scale3d(" + num + " , " + num + " , " + "1)";
        _o.transform = "scale3d(" + num + " , " + num + " , " + "1)";
        _o.msTransform = "scale3d(" + num + " , " + num + " , " + "1)";
        _o.MozTransform = "scale3d(" + num + " , " + num + " , " + "1)";
        _o.oTransform = "scale3d(" + num + " , " + num + " , " + "1)";
        ...
        if (mode == "contain" || mode == "cover") {
            ...
            _o.msTransformOrigin = "center center 0";
            _o.MozTransformOrigin = "center center 0";
            _o.oTransformOrigin = "center center 0";
            // 阻止默认滑屏事件
            if (wp) {
